  ...
  : QTextEdit(parent)
{
  ...
  for (const auto *x :
       {"quote", "and",   "or",   "do",   "cons", "car", "cdr",       "setcar",  "setcdr", "list",  "not", "is",
        "atom",  "print", "fsin", "fcos", "sin",  "cos", "tan",       "asin",    "acos",   "atan",  "deg", "rad",
        "floor", "ceil",  "sqrt", "abs",  "max",  "min", "animation", "require", "group",  "helper"})
